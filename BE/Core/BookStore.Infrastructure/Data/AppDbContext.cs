...
using CartEntities = BookStore.Domain.Entities.Cart;
...
namespace BookStore.Infrastructure.Data
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<CartEntities.Cart> Carts { get; set; } = null!;
        public DbSet<CartEntities.CartItem> CartItems { get; set; } = null!;
