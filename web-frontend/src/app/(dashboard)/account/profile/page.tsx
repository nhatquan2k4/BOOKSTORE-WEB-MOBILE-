      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              <Link
                href="/account/profile/update-profile"
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-yellow-700 mb-4">
                  Vui lòng xác minh email của bạn để đảm bảo tài khoản được bảo mật và
                ...
                {user.isActive ? (
                  <span className="inline-flex items-center px-2 py-1 bg-green-100 text-green-700 text-xs font-medium rounded">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M10 18a8 8 0 1 0-8-8 8.009 8.009 0 0 0 8 8Zm3.707-9.707-4 4a1 1 0 0 1-1.414 0l-2-2A1 1 0 1 1 7.707 9.293L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"
                        clipRule="evenodd"
                      />
                    </svg>
                    Đã xác minh
                  ...
                  <span className="inline-flex items-center px-2 py-1 bg-yellow-100 text-yellow-700 text-xs font-medium rounded">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92ZM11 13a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm-1-5a1 1 0 0 0-1 1v3a1 1 0 1 0 2 0V9a1 1 0 0 0-1-1Z"
                        clipRule="evenodd"
                      />
                    </svg>
                    Chưa xác minh
