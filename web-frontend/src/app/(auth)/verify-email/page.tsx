...
// 1. Component con chứa toàn bộ logic chính (dùng useSearchParams)
function VerifyEmailContent() {
  ...
  useEffect(() => {
    if (token) {
      ...
      setStatus("error");
      setMessage("Token xác minh không hợp lệ hoặc thiếu thông tin.");
    }
  ...
  return (
    <div className="max-w-md w-full">
      <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
        <Loader2 className="w-12 h-12 text-blue-600 animate-spin mx-auto mb-4" />
        <p className="text-gray-600">Đang tải trang xác thực...</p>
      </div>
    </div>
  );
}
