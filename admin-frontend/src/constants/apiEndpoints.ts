...
export const API_ENDPOINTS = {
  ...
  BOOK: {
    ...
    GET_BY_PUBLISHER: (publisherId: string) =>
  ...
  REVIEWS: {
    ...
    DELETE: (bookId: string, reviewId: string) =>
      `/books/${bookId}/reviews/${reviewId}`,
  },
  ...
  BOOK_COMMENTS: {
    ...
    UPDATE: (bookId: string, commentId: string) =>
      `/books/${bookId}/comments/${commentId}`,
    DELETE: (bookId: string, commentId: string) =>
      `/books/${bookId}/comments/${commentId}`,
  },
  ...
  BOOK_IMAGES: {
    ...
    DELETE: (bookId: string, imageId: string) =>
      `/books/${bookId}/images/${imageId}`,
    SET_PRIMARY: (bookId: string, imageId: string) =>
      `/books/${bookId}/images/${imageId}/primary`,
  },
